...
console.log(__dirname);           // string name represents full path to the folder where file is located
console.log(__filename);          // string name represents full path to the file
...
console.log(path.resolve("/folder1","//folder2","../index.html"))
// folder2 is root comes out and gives index.html alone
